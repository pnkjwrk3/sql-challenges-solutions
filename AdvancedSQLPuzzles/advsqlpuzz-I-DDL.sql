...
(EXTRACT(YEAR FROM CURRENT_DATE - INTERVAL '2 YEAR'), 159521),
(EXTRACT(YEAR FROM CURRENT_DATE - INTERVAL '2 YEAR'), 251696),
(EXTRACT(YEAR FROM CURRENT_DATE - INTERVAL '3 YEAR'), 111894);
...
(
RowNumber        INTEGER SERIAL PRIMARY KEY,
